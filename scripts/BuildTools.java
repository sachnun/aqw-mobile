...
public class BuildTools {
    ...
    private static void printUsage() {
        ...
        System.err.println("  java scripts/BuildTools.java extract-library-swf <input.swc> <output.swf>");
        System.err.println("  java scripts/BuildTools.java normalize-aab <input.aab> <output.aab>");
        System.err.println("  java scripts/BuildTools.java inspect-native-libs <input.apk>");
    }
}
